...
- **Flared Walls:** Includes a customizable flare angle (0-80 degrees) to give the saucer a cleaner, more aesthetic look compared to vertical sides.
...
3. Adjust the variables at the top of the file to match your pot:
   ```openscad
   pot_diameter = 178; // The bottom diameter of your pot
   wall_height = 8;    // How tall the side walls should be
   ```
...
| :------------- | :------ | :------------------------------------------------------------------------- |
| `pot_diameter` | 178     | Diameter of the pot bottom (mm).                                           |
| `wall_height`  | 8       | Height of the outer rim (mm).                                              |
| `flare_angle`  | 50      | Outward angle of the walls (0-80 degrees).                                 |
| `floor_thick`  | 2.0     | Thickness of the solid bottom base (mm).                                   |
| `wall_thick`   | 2.0     | Thickness of the vertical side walls (mm).                                 |
| `rib_height`   | 3       | Air gap under the pot (mm).                                                |
| `rib_thick`    | 2.0     | Thickness of the internal ribs (mm).                                       |
| `rib_count`    | 10      | Set to 0 for automatic calculation, or a number to force a specific count. |
